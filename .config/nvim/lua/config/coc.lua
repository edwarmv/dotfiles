vim.g.coc_node_path = "/Users/edwar/.asdf/shims/node"
...
keyset("n", "gld", "<Plug>(coc-definition)", { silent = true })
keyset("n", "gly", "<Plug>(coc-type-definition)", { silent = true })
keyset("n", "gli", "<Plug>(coc-implementation)", { silent = true })
keyset("n", "glr", "<Plug>(coc-references)", { silent = true })
...
keyset("n", "<C-f>", function()
  return vim.fn["coc#float#has_scroll()"] == 1 and "coc#float#scroll(1)" or "<C-f>"
end, opts)
keyset("n", "<C-b>", function()
  return vim.fn["coc#float#has_scroll()"] == 1 and "coc#float#scroll(0)" or "<C-b>"
end, opts)
