...
call gruvbox_material#highlight('MasonNormal', l:palette.fg0, l:palette.none)
  ...
  call gruvbox_material#highlight('LeapMatch', l:palette.green, l:palette.none, 'nocombine,underline,bold')
  ...
  call gruvbox_material#highlight('LeapBackdrop', l:palette.grey1, l:palette.none)
  ...
  " hi typescriptParens ctermfg=223 guifg=#d4be98
